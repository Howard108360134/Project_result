    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_query.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                c.moveToFirst();
                items.clear();
                Toast.makeText(fitness.this, "共有" + c.getCount() +
        ...
        btn_insert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(ed_sport.length()<1 || yn.length()<1)
                    Toast.makeText(fitness.this, "欄位請勿留空",
                    ...
                    try{
                        ...
                        Toast.makeText(fitness.this, "新增失敗:"+
        ...
        btn_delete.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                if(ed_sport.length()<1)
                    Toast.makeText(fitness.this,"運動項目請勿留空",Toast.LENGTH_SHORT).show();
                else{
                    try{
                        dbrw.execSQL("DELETE FROM myTable WHERE sport LIKE '" +ed_sport.getText().toString() + "'");
                        Toast.makeText(fitness.this, "刪除運動"+
                                ed_sport.getText().toString() , Toast.LENGTH_SHORT).show();

                        ed_sport.setText("");
                        //yn.setText("");
                    }catch (Exception e){
                        Toast.makeText(fitness.this, "刪除失敗:"+
                                e.toString(),Toast.LENGTH_LONG).show();
        ...
        dbrw = new MyDBHelper1(this).getWritableDatabase();

        back = findViewById(R.id.btn_back);
        back.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                startActivityForResult(new Intent(fitness.this,
